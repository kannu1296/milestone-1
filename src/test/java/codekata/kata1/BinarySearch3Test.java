...
@PrepareForTest(BinarySearch3.class)
public class BinarySearch3Test {
    ...
    public void binarySearchOddArray1() {
        int index = BinarySearch3.binarySearch(2, new int[]{3, 2, 1});
    ...
    public void binarySearchOddArray2() {
        int index = BinarySearch3.binarySearch(1, new int[]{3, 2, 1});
    ...
    public void binarySearchOddArray3() {
        int index = BinarySearch3.binarySearch(3, new int[]{3, 2, 1});
    ...
    public void binarySearchOddArray4() {
        int index = BinarySearch3.binarySearch(4, new int[]{3, 2, 1});
        Assert.assertEquals(-1, index);
    }
    ...
    public void binarySearchEvenArray1() {
        int index = BinarySearch3.binarySearch(2, new int[]{4, 3, 2, 1});
        Assert.assertEquals(2, index);
    }
    ...
    public void binarySearchEvenArray2() {
        int index = BinarySearch3.binarySearch(1, new int[]{4, 3, 2, 1});
    ...
    public void binarySearchEvenArray3() {
        int index = BinarySearch3.binarySearch(4, new int[]{4, 3, 2, 1});
        Assert.assertEquals(0, index);
    }
    ...
    public void binarySearchEvenArray4() {
        int index = BinarySearch3.binarySearch(10, new int[]{4, 3, 2, 1});
        Assert.assertEquals(-1, index);
    }
    ...
    public void binarySearchEmptyArray() {
        int index = BinarySearch3.binarySearch(10, new int[]{});
        Assert.assertEquals(-1, index);
    }
