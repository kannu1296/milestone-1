...
@PrepareForTest(BinarySearch5.class)
public class BinarySearch5Test {
    private BinarySearch5 binarySearch5;

    @Before
    public void setUp() {
        binarySearch5 = new BinarySearch5();
    }
    ...
    public void binarySearchOddArray1() {
        int index = binarySearch5.binarySearch(2, new int[]{1, 2, 3});
    ...
    public void binarySearchOddArray2() {
        int index = binarySearch5.binarySearch(1, new int[]{1, 2, 3});
    ...
    public void binarySearchOddArray3() {
        int index = binarySearch5.binarySearch(3, new int[]{1, 2, 3});
    ...
    public void binarySearchOddArray4() {
        int index = binarySearch5.binarySearch(4, new int[]{1, 2, 3});
        Assert.assertEquals(-1, index);
    }
    ...
    public void binarySearchEvenArray1() {
        int index = binarySearch5.binarySearch(2, new int[]{1, 2, 3, 4});
        Assert.assertEquals(1, index);
    }
    ...
    public void binarySearchEvenArray2() {
        int index = binarySearch5.binarySearch(1, new int[]{1, 2, 3, 4});
        Assert.assertEquals(0, index);
    }
    ...
    public void binarySearchEvenArray3() {
        int index = binarySearch5.binarySearch(4, new int[]{1, 2, 3, 4});
    ...
    public void binarySearchEvenArray4() {
        int index = binarySearch5.binarySearch(10, new int[]{1, 2, 3, 4});
        Assert.assertEquals(-1, index);
    }
    ...
    public void binarySearchEmptyArray() {
        int index = binarySearch5.binarySearch(10, new int[]{});
        Assert.assertEquals(-1, index);
    }
